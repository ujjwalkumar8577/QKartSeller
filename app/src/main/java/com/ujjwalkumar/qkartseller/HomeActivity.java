...
public class HomeActivity extends AppCompatActivity {
    ...
    private final DatabaseReference db2 = _firebase.getReference("consumers");
    ...
    protected void onCreate(Bundle _savedInstanceState) {
        ...
        imageviewabout.setOnClickListener(_view -> {
        ...
        lineardash.setOnClickListener(_view -> {

        });

        linearcomp.setOnClickListener(_view -> {
            inh.setAction(Intent.ACTION_VIEW);
        ...
        linearitems.setOnClickListener(_view -> {
            inh.setAction(Intent.ACTION_VIEW);
        ...
        linearhelp.setOnClickListener(_view -> {
            inh.setAction(Intent.ACTION_VIEW);
        ...
        linearaccount.setOnClickListener(_view -> {
            inh.setAction(Intent.ACTION_VIEW);
    ...
    private void _loadlist() {
        db3.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot _dataSnapshot) {
                ...
                t = 0;
                u = 0;
                for (int _repeat11 = 0; _repeat11 < lmp_orders.size(); _repeat11++) {
    ...
    public class Listview1Adapter extends BaseAdapter {
        ...
        public View getView(final int _position, View _view, ViewGroup _viewGroup) {
            ...
            status = Double.parseDouble(filtered.get(_position).get("status").toString());
            ...
            linear4.setOnClickListener(_view14 -> {
                confirm.setTitle("Confirm");
                confirm.setMessage("Do you want to mark it as 'ordered'?");
                confirm.setPositiveButton("Yes", (_dialog, _which) -> {
                    order = new HashMap<>();
                    order.put("oid", filtered.get(_position).get("oid").toString());
                    order.put("selleruid", filtered.get(_position).get("selleruid").toString());
                    order.put("custuid", filtered.get(_position).get("custuid").toString());
                    order.put("amt", filtered.get(_position).get("amt").toString());
                    order.put("status", "1");
                    order.put("time", filtered.get(_position).get("time").toString());
                    order.put("comment", filtered.get(_position).get("comment").toString());
                    order.put("custmap", filtered.get(_position).get("custmap").toString());
                    order.put("sellermap", filtered.get(_position).get("sellermap").toString());
                    order.put("itemmap", filtered.get(_position).get("itemmap").toString());
                    ...
                    filtered.get(_position).put("status", "1");
            ...
            linear5.setOnClickListener(_view13 -> {
                confirm.setTitle("Confirm");
                ...
                confirm.setPositiveButton("Yes", (_dialog, _which) -> {
                    ...
                    imageview3.setImageResource(R.drawable.status0);
                    imageview4.setImageResource(R.drawable.status0);
                    filtered.get(_position).put("status", "2");
            ...
            linear6.setOnClickListener(_view12 -> {
                confirm.setTitle("Confirm");
                ...
                confirm.setPositiveButton("Yes", (_dialog, _which) -> {
                    ...
                    imageview3.setImageResource(R.drawable.status3);
                    imageview4.setImageResource(R.drawable.status0);
                    filtered.get(_position).put("status", "3");
            ...
            linear7.setOnClickListener(_view1 -> {
                confirm.setTitle("Confirm");
                ...
                confirm.setPositiveButton("Yes", (_dialog, _which) -> {
                    ...
                    imageview3.setImageResource(R.drawable.status3);
                    imageview4.setImageResource(R.drawable.status4);
                    filtered.get(_position).put("status", "4");
